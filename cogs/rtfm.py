...
class Rtfm(commands.Cog):
    ...
    async def do_rtfm(self, ctx, key: str, obj: Optional[str]):
        page_types = {
        ...
        obj = re.sub(r'^(?:discord.py\.(?:ext\.)?)?(?:commands\.)?(.+)', r'\1', obj)
